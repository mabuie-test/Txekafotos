                    ...
                    <div class="card-body p-4 p-lg-5">
                        ...
                        <form method="post" action="/pedido" enctype="multipart/form-data" class="row g-4 needs-validation" novalidate>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="client_name" class="form-control" value="<?= e((string) old('client_name')) ?>" required>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="description" rows="6" class="form-control" placeholder="Ex.: Quero inserir meu pai na foto, usar a segunda foto como referência, remover riscos e melhorar as cores..." required><?= e((string) old('description')) ?></textarea>
